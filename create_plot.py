################################################
# This code is used to create a choice of plot #
# from predetermined axis from a dataframe.    #
# The code consist of 2 class, where the first #
# one is to read some file into dataframe and  #
# determine the X and Y axis, while the second #
# one to generete plot.                        #
################################################
# by           : Shandy Yogaswara              #
...
class MultiPlot:
    ...
    def line_bar(self):
        ...
        '''
        self.ax.plot(self.x,self.y1,label=self.label_y1)
        self.ax.bar(self.x,self.y2,label=self.label_y2)
        self.ax.legend(loc='upper right')
...
if __name__ == '__main__':
    ...
    #plot.single_line()
    plot = MultiPlot(x,y[0],y0_axis,y[1],y1_axis,x_axis)
    plot.line_bar()
    plt.show()